...
<body class="bg-gray-400">
	...
	<div class="text-center py-8">
		...
		<div class="mt-4">
			<a href="new"
				class="inline-block px-4 py-2 text-white bg-green-300 rounded">Add
				New Student</a> <a href="list"
				class="inline-block px-4 py-2 text-white bg-blue-400 rounded ml-2">List
				All Students</a> <a href="logout"
				class="inline-block px-4 py-2 text-white bg-red-400 rounded ml-2">Logout</a>
		</div>
	</div>
